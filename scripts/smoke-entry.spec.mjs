...
// pinned in `tests/surface/surface-coverage-config-pins.spec.ts`; what this file pins is
...
// fact about that file, and `tests/surface/surface-coverage-config-pins.spec.ts` fails
