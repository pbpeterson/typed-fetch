...
// `tests/surface/surface-coverage-config-pins.spec.ts`. Item 2's thresholds are pinned by
// `tests/surface/surface-gate-script-exports.spec.ts`, and R18-H4-04 made that pin read
