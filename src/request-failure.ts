 ...
 *
 * This is a statement about REJECTION shapes only. `isResponse` in
 * `src/index.ts` separately decides whether to accept a resolved value.
 * `whatwg-fetch` fails that check because it exposes no `body` stream.
 *
