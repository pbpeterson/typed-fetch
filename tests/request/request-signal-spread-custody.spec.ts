...
describe("the entry a forwarding transport's spread carries", () => {
...
describe("what the signal-forwarding pins can still fail for", () => {
  test("R19-H1-02: the pin that names R18-H1-01's defect passes against the defect", () => {
    ...
    // `tests/request/request-init-branch-parity.spec.ts`, which is
...
describe("transport re-entry on the branch round 18 opened", () => {
...
describe("phase 3 against the platform values round 18 did not build", () => {
