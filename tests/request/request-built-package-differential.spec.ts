...
warnWhenDistMissing("request-built-package-differential", distExists);
...
describe.skipIf(!distExists)("the transport re-entry sentence, against dist", () => {
...
describe.skipIf(!distExists)("the phase 3 cross-call release, against dist", () => {
...
describe.skipIf(!distExists)("the success differential against a bare fetch", () => {
...
describe.skipIf(!distExists)("the HTTP-error differential against a bare fetch", () => {
...
describe.skipIf(!distExists)("the failure differential against a bare fetch", () => {
