...
// `request-signal-spread-enumerability.spec.ts`, "R20-H1-02: the fetch-option branch invents a
...
describe("one property, over the cells the corpus never drew", () => {
...
describe("the shapes are the cells", () => {
...
describe("the two wrong inits, and which pin sees them", () => {
...
describe("what the plan still promises after the caller writes", () => {
...
describe("the descriptor write, against the bare platform", () => {
  let base = "";
