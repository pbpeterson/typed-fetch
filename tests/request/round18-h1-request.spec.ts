...
warnWhenDistMissing("round18-h1-request", distExists);
...
describe.skipIf(!distExists)("round 18 / H1 — the init members, on both branches", () => {
...
describe.skipIf(!distExists)("round 18 / H1 — a body that dies mid-read", () => {
  test.each([
...
describe.skipIf(!distExists)("round 18 / H1 — phase 3 against genuine responses", () => {
...
describe.skipIf(!distExists)("round 18 / H1 — concurrency the platform schedules", () => {
