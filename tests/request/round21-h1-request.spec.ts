...
describe("round 21 / H1 — the fresh target, under a corpus", () => {
  test.each(CASES)(
...
describe("round 21 / H1 — the corpus, through a forwarding transport", () => {
...
describe("round 21 / H1 — the descriptor bag is read through Object.prototype", () => {
...
describe("round 21 / H1 — the no-signal branch, asked the signal branch's questions", () => {
...
describe("round 21 / H1 — the invariant's domain, stated executably", () => {
