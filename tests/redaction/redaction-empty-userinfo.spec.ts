 ...
 * axis are copied from `redaction-embedded-authority-port.spec.ts`; importing that file
...
describe("R18-H3-02 — the residue round 19 closed", () => {
  test(
    ...
    () => {
      ...
      // zero and stays zero, and `removed` in `redaction-embedded-authority-port.spec.ts`
