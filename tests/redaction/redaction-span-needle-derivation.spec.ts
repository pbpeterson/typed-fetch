...
describe("one needle per path span, and the mention the wide needle misses", () => {
...
describe("the seventh instrument, and the quantity the six cannot see", () => {
...
describe("the pass count, which the two routes cannot spend alike", () => {
...
describe("the grid, round 22's four conditions crossed with what predates 21", () => {
