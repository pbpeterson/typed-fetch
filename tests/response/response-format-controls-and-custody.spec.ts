...
describe("Unicode format controls and legitimate joiners", () => {
  test.each([
...
function foreignResponse(responseBody: ForeignBody): Response {
  const response: Record<PropertyKey, unknown> = {
    ...
    type: "basic",
    url: "https://response-format-controls-and-custody.invalid/resource",
...
describe("foreign identity and body custody", () => {
