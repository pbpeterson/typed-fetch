...
// url, and `round17-h3-disclosure.spec.ts` pins the answer: the url unchanged.
...
describe("round 18 / H2 — the crossing hands `readsAsHostAndPort` the wrong mark", () => {
...
describe("round 18 / H2 — a mark that spells no scheme still suppresses the rule", () => {
...
describe("round 18 / H2 — the two floors hold the pass count constant", () => {
...
describe("round 18 / H2 — conditions two and three answer for their own reason", () => {
...
describe("round 18 / H2 — the loop ends, and the relative branch stays the caller's", () => {
