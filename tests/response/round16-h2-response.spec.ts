...
describe("round 16 / H2 — the pass count is still a number the redirect target picks", () => {
...
describe("round 16 / H2 — a 302 Location chooses how many passes toJSON() runs", () => {
...
describe("round 16 / H2 — the loop's measure holds over the shape that reaches its bound", () => {
...
describe("round 16 / H2 — the relative branch's reachability, on both sides", () => {
