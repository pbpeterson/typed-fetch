...
describe("round 21 / H2 — a credential the scanner finds and no message can lose", () => {
  /**
...
describe("round 21 / H2 — an opaque url is handed the seam question", () => {
...
describe("round 21 / H2 — the grid, round 20's changes crossed with what predates them", () => {
...
describe("round 21 / H2 — `endsAuthority(character, folds)` and its six call sites", () => {
...
describe("round 21 / H2 — a fifth instrument, and the bound it reports", () => {
