...
describe("round 19 / H2 — the colon search walks the rest of the url, per region", () => {
...
describe("round 19 / H2 — one url, five spellings of its mark, three answers", () => {
...
describe("round 19 / H2 — the triplewise grid, and what it cleared", () => {
  test(
